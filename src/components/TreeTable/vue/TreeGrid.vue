<template>
    <div>
        <el-table :data="data" border :row-style="showTr">
            <el-table-column :label="column.text" v-for="(column,index) in columns" :key="index" :width="column.width?column.width:''">
            ...
            <el-table-column label="操作"  width="260">
                <template slot-scope="props">
                    <button type="button" class="el-button el-button--default el-button--small" v-if="props.row.type === '主包' ">
                        添加分包
                    </button>
                    <button type="button" class="el-button el-button--default el-button--small" v-if="">
                        编辑
                    </button>
