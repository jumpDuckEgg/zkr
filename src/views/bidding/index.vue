    ...
    <div class="app-container">
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="跟踪中的项目" name="跟踪中的项目">
                ...
                <normaltable tableType='跟踪中的项目' :loading='trackTable.loading' :tableMaxWidth='trackTable.tableMaxWidth' :columns='trackColumns' :tableData='trackTableData' @multipleSelection='multipleSelections' @sort='tableSort' @enroll='enroll'></normaltable>
            ...
            <el-tab-pane label="确定报名的项目" name="确定报名的项目">
                ...
                <el-row type="flex" justify="start">
                    <el-col>
                        ...
                        <el-button size="mini" type="danger" plain @click="changeStatusBidding('track')">弃标</el-button>
                    </el-col>
                </el-row>
